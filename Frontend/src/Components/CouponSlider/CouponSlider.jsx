...
const CouponSlider = () => {
  return (
    <div className="w-full bg-gray-100 overflow-hidden md:px-14 ms: px-4 py-8" id='newcoupon'>
      <h2 className="text-xl font-semibold pl-4 mb-6">New Coupons</h2>
      <Swiper
        modules={[Autoplay]}
        spaceBetween={20}
        slidesPerView={1}
